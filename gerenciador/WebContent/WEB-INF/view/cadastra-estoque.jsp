                    ...
                    <ul class="text-white info-resultado">
                        ...
                        <li class="animated fadeInLeft delay-01s mb-3 d-flex justify-content-between">
                            <div class="d-flex justify-content-between">
                                <label for="nome" class="mr-2">Unidade:</label>
                                <select class="text-white bg-dark border-none" id="unidade" name="unidade">
                        ...
                        <li class="animated fadeInLeft delay-01s mb-3 d-flex justify-content-between">
                            <div class="d-flex justify-content-between">
                                <label for="nome" class="mr-2">Quantidade:</label>
                                <input type="number" class="input-produto w-100" id="quantidade" 
                                    name="quantidade" min="1" required>
                            </div>
                            <div class="d-flex justify-content-between">
                                <label for="nome" class="mr-2">Total:</label>
                                <input type="text" class="input-produto w-100 text-right"
                                     id="total" name="total" readonly required>
                            </div>
                        </li>
