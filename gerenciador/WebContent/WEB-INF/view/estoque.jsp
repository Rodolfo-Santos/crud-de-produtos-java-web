...
<%@ page import="java.util.List, br.com.fatec.gerenciador.model.Produto"%>
        ...
        <div class="container m-auto row venda-conteudo mb-4">
            <div class="col-12 col-md-12 d-flex flex-column">
                ...
                <div class="row ml-1 justify-content-between animated fadeInDown">
                    ...
                    <form class="form-inline col-12 col-md-4 justify-content-end form-search">
                        <input id="filtrar-tabela" class="form-control input-venda input-estoque" type="search" placeholder="Search"
                            aria-label="Search">
                        <button class="btn position-relative" type="submit"><img src="img/icons/search.svg" alt=""
                                class="icon icon-text"></button>
                    </form>
                </div>
                    	...
                    	<c:forEach items="${produtos}" var="produto">
	                        <tr class="produto animated fadeInLeft">
	                            ...
	                            <td class="info-Total">${ produto.total }</td>
               	                <td class="editar"> <a href="entrada?acao=editar_produto&id=${ produto.id }">Editar</a> </td>
	                            <td class="remover"> <a href="entrada?acao=removendo_produto&id=${ produto.id }">Remover</a> </td>
	                        </tr>
                    	</c:forEach>
                    </tbody>
                </table>
