				...
				<ul class="text-white info-resultado">
					...
					<li
						...
						<div class="d-flex justify-content-between">
							<label for="nome" class="mr-2">Unidade:</label> <select
								class="text-white bg-dark border-none" id="unidade"
								name="unidade">
								<option class="">Unidade</option>
								<option class="">Caixa</option>
								<option class="">Gramas</option>
								<option class="">Litros</option>
							</select>
						</div>
						<div class="d-flex justify-content-between">
					...
					<li
						class="animated fadeInLeft delay-01s mb-3 d-flex justify-content-between">
						<div class="d-flex justify-content-between">
							<label for="nome" class="mr-2">Quantidade:</label> <input
								type="number" class="input-produto w-100" id="quantidade"
								name="quantidade" min="1" value="${ produto.quantidade }"
								required>
						</div>
						<div class="d-flex justify-content-between">
							<label for="nome" class="mr-2">Total:</label> <input type="text"
								class="input-produto w-100 text-right" id="total" name="total"
								readonly required>
						</div>
					</li>
					...
					<li
						class="animated fadeInLeft delay-01s mb-3 d-flex justify-content-between">
						<label for="nome" class="mr-2">Descrição:</label> <input type="text"
							class="w-100 input-produto" name="descricao" value="${ produto.descricao }" required>     	
					</li>
