<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.List, br.com.fatec.gerenciador.model.Produto"%>
		...
		<div class="col-12 col-md-6 d-flex flex-column">
			...
			<c:if test="${not empty produto}">
				...
				<ul class="text-muted info-resultado">
					...
					<li class="animated fadeInLeft delay-04s"><span>Unidade:</span>
						<p>${ produto.unidade }</p></li>
					<ul class="animated fadeInLeft delay-05s">
						<li><span>Preço por Unidade:</span>
							<p>R$ ${ produto.preco }</p></li>
						<li><span>Qnt.Estoque:</span>
							<p>${ produto.quantidade }</p></li>
					</ul>
				</ul>
				<div class="line">
					<span class="animated fadeInLeft delay-03s"></span>
